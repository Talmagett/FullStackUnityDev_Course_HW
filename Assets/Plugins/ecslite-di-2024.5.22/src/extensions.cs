...
namespace Leopotam.EcsLite.Di
{
    ...
    public static class Extensions
    {
        ...
        public static bool InjectBuiltIns(FieldInfo fieldInfo, object target, IEcsSystems systems)
        {
        ...
        public static bool InjectCustoms(FieldInfo fieldInfo, object target, object[] injects)
        {
            if (typeof(IEcsCustomDataInject).IsAssignableFrom(fieldInfo.FieldType))
            {
                var instance = (IEcsCustomDataInject) fieldInfo.GetValue(target);
